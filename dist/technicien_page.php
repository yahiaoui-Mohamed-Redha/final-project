...
// Verify user authorization - CHANGED TO TECHNICIEN
if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'Technicien') {
    header('location: index.php');
    exit();
}

// Fetch technicien details - CHANGED VARIABLE NAMES FOR CLARITY
...
$stmt_count->execute([$technicien_id]);
...
<head>
    ...
    <!-- CHANGED TITLE TO TECHNICIEN PAGE -->
...
<body class="bg-[#f6f6f6]">
            ...
            <nav class="w-full pr-5 nav fixed-on-h632 -mx-3 bottom-6 top-[90px] flex flex-col flex-1 justify-between space-y-4">
                ...
                <div class="space-y-4">
                    <div class="space-y-2.5 ">
                        ...
                        <!-- CHANGED admin_id TO technicien_id IN LINKS -->
                        <a class="flex items-center px-3 py-2 mt-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-[#c8d3f659] hover:text-[#0455b7]" href="statistiques/statistiques.php?technicien_id=<?php echo $technicien_id; ?>">
                    ...
                    <div class="space-y-2.5 ">
                        ...
                        <a class="flex items-center px-3 py-2 mt-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-[#c8d3f659] hover:text-[#0455b7]" href="gerer_les_panne/gerer_pn.php?technicien_id=<?php echo $technicien_id; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        ...
                        <a class="flex items-center px-3 py-2 mt-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-[#c8d3f659] hover:text-[#0455b7]" href="gerer_les_rapport/gerer_rp.php?technicien_id=<?php echo $technicien_id; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        ...
                        <a class="flex items-center px-3 py-2 mt-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-[#c8d3f659] hover:text-[#0455b7]" href="gerer_les_ordres_des_missions/gerer_ord.php?technicien_id=<?php echo $technicien_id; ?>">
                            ...
                            <span class="mx-2 text-sm font-medium">Souiver orders de mission</span>
                        </a>

                        <a class="flex items-center px-3 py-2 mt-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-[#c8d3f659] hover:text-[#0455b7]" href="gerer_les_fiche_dintervention/P-GFI.php?technicien_id=<?php echo $technicien_id; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                ...
                <div class="space-y-2.5">
                    ...
                    <a class="flex items-center px-3 py-2 mt-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-[#c8d3f659] hover:text-[#0455b7]" href="Parametres/Parametres.php?technicien_id=<?php echo $technicien_id; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
    ...
    <script>
            ...
            setTimeout(function() {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        history.pushState({ page: page }, "", "technicien_page.php?contentpage=" + page);
        ...
        function setActiveLink() {
            var currentPage = sessionStorage.getItem("currentPage") || 'statistiques/statistiques.php?technicien_id=<?php echo $technicien_id; ?>';
        ...
        $(document).ready(function() {
            ...
            if (currentPage) {
                ...
                loadPage('statistiques/statistiques.php?technicien_id=<?php echo $technicien_id; ?>'); // Default page
            }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response === "Data inserted successfully") {
                            ...
                            window.location.href = 'technicien_page.php?contentpage=gerer_les_comptes/manage_users.php';
                        } else {
            ...
            $('#panneForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response === "Data inserted successfully") {
                            alert("Account created successfully!");
                            window.location.href = 'technicien_page.php?contentpage=gerer_pn/signaler_des_panne.php';
                        } else {
                            alert("Error: " + response);
