    ...
    <div class="content sm:ml-[17rem] w-[calc(100%-16.3rem)] float-right">
        <header class="bg-white shadow-md p-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-9">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-800"><?php echo htmlspecialchars($Receveur['nom'] . ' ' . $Receveur['prenom']); ?></p>
                    <p id="role" class="text-xs text-gray-500"><?php echo $Receveur['role_name']; ?></p>
                </div>
                </div>
...
<!-- <body class=" bg-amber-400">
    <header>
        ...
        <p>Hello, <?php echo htmlspecialchars($Receveur['username']); ?>!</p>
