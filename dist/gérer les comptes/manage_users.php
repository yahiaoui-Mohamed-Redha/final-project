            ...
            <nav class="-mx-3 fixed bottom-6 top-[90px] flex flex-col flex-1 justify-between space-y-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2.5 ">
                        ...
                        <a class="flex items-center px-3 py-2 mt-2 text-[#0455b7] bg-[#c8d3f659] transition-colors duration-300 transform rounded-lg" href="gérer les comptes/manage_users.php?admin_id=<?php echo $user_id; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" stroke-width="1.5">
